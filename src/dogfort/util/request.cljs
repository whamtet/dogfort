(ns dogfort.util.request
  "Functions for augmenting and pulling information from request maps."
  (:require [dogfort.util.parsing :refer [re-value]]))
...
#_(defmethod body-string nil [_] nil)

#_(defmethod body-string String [request]
  (:body request))

#_(defmethod body-string clojure.lang.ISeq [request]
  (apply str (:body request)))

#_(defmethod body-string java.io.File [request]
  (slurp (:body request)))

#_(defmethod body-string java.io.InputStream [request]
  (slurp (:body request)))
